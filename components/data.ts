import { Activity, Bath, BedDouble, HeartPulse, Home, PackageCheck, PersonStanding, ShoppingBasket, Stethoscope, Utensils } from "lucide-react";
export const categories=[
 {name:"Groceries",count:"500+ essentials",icon:"ShoppingBasket"},{name:"Health Essentials",count:"300+ products",icon:"HeartPulse"},{name:"Medical Devices",count:"100+ devices",icon:Stethoscope},{name:"Personal Care",count:"250+ items",icon:"Bath"},{name:"Mobility Aids",count:"150+ solutions",icon:"PersonStanding"},{name:"Nutrition",count:"200+ products",icon:"Utensils"},{name:"Home Care",count:"150+ items",icon:"Home"},{name:"Care Boxes",count:"Curated care",icon:PackageCheck}
];
export const products=[
 ...
 {id:"grocery-pack",name:"Monthly Grocery Pack",category:"Groceries",price:1999,mrp:2399,rating:5,icon:"ShoppingBasket"},
...
export const careBoxes=[
 {id:"monthly",name:"Monthly Care Box",description:"Groceries, nutrition and daily essentials.",price:1999},
